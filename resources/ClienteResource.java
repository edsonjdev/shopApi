...
import com.edson.shop.service.ClienteService;
...
public class ClienteResource {
	 ...
	 * Page<Cliente> list = service.findPage(page, linesPerPage, orderBy,
	 * direction); Page<ClienteDTO> listDTO = list.map(obj -> new ClienteDTO(obj));
	 * return ResponseEntity.ok().body(listDTO); }
	 */
